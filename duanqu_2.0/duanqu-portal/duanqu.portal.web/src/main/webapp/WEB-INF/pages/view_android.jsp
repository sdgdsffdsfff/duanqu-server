...
.content{ padding:5px; font-family:"微软雅黑"; }
...
<script type='text/javascript'>
  var so = new SWFObject('http://danqoo-video-online.b0.upaiyun.com/static/player/player.swf','mpl', document.body.clientWidth - 10, document.body.clientWidth - 10,'9');
