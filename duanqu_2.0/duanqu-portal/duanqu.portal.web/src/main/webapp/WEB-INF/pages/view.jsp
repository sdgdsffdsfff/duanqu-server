...
.userHeadImg{ float:left; -webkit-border-radius: 5px;border-radius: 5px;}
...
<script type='text/javascript' src='http://danqoo-video-online.b0.upaiyun.com/static/player/swfobject.js'></script>
...
<img src="${user.avatar}"  class="userHeadImg" width="80">
...
<div>
<div  class="content">
<div id='mediaspace'>播放器</div>

<script type='text/javascript'>
  var so = new SWFObject('http://danqoo-video-online.b0.upaiyun.com/static/player/player.swf','mpl','600','600','9');
  so.addParam('allowfullscreen','true');
  so.addParam('allowscriptaccess','always');
  so.addParam('wmode','opaque');
  so.addVariable('file','${content.videoUrlHD}');
  so.addVariable('image','${content.thumbnailsUrl}');
  so.write('mediaspace');
</script>
